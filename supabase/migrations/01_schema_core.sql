-- ============================================================================
-- 01_schema_core.sql
-- Purpose: Create all core tables in correct FK order with RLS
-- Run Order: 2 of 3 (after 00_preflight.sql)
-- ============================================================================
-- LOCALIZATION: country/currency/language/timezone are NULLABLE
-- Set per tenant during onboarding, NOT hardcoded defaults
-- ============================================================================
...
-- ============================================================================
-- TIER 2: TENANT-USER JUNCTION (Must exist before RLS policies)
-- ============================================================================
...
-- ============================================================================
-- TIER 6: EXPERIMENTS, DECISIONS, INSIGHTS
-- ============================================================================
...
-- ============================================================================
-- TIER 9: AI GENERATION & DEPLOYMENTS
-- ============================================================================
...
-- V1: Check all tables created
-- SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' ORDER BY table_name;

-- V2: Check tenant_users exists
-- SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'tenant_users';

-- V3: Check RLS enabled
